...
class screen_setup:
    ...
    def __init__(self, ipm):
        ...
        ipm.fill_rect(550, 350, 175, 10, 1)  # Bottom line  devider
        ipm.fill_rect(720, 0, 10, 600, 1)  # Warnings devider
        ipm.fill_circle(790, 490, 5, 1)  # Target Speed decimal
        ...
        self.numLookupSmallest = {
                "1": self.__formCharacter(NUM_SMALLEST, "1"),
                "2": self.__formCharacter(NUM_SMALLEST, "2"),
                "3": self.__formCharacter(NUM_SMALLEST, "3"),
                "4": self.__formCharacter(NUM_SMALLEST, "4"),
                "5": self.__formCharacter(NUM_SMALLEST, "5"),
                "6": self.__formCharacter(NUM_SMALLEST, "6"),
                "7": self.__formCharacter(NUM_SMALLEST, "7"),
                "8": self.__formCharacter(NUM_SMALLEST, "8"),
                "9": self.__formCharacter(NUM_SMALLEST, "9"),
                "0": self.__formCharacter(NUM_SMALLEST, "0")
            }
    ...
    def NumLookupSmallest(self, num: str):
        return self.numLookupSmallest[num]
